    ...
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 rounded-lg bg-primary/10 p-6 text-center">
          ...
          <h2 className="mb-2 text-2xl font-bold">100% Hàng Chính Hãng</h2>
          <p className="text-muted-foreground">
            ShopCuaThuy cam kết mọi sản phẩm đều là hàng chính hãng, có nguồn gốc xuất xứ rõ ràng và được bảo hành đầy
            đủ.
          </p>
        </div>
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-2">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Tất cả sản phẩm đều được nhập khẩu chính hãng từ các nhà phân phối ủy quyền hoặc trực tiếp từ thương
                hiệu.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Mọi sản phẩm đều được kiểm tra kỹ lưỡng về chất lượng và tính xác thực trước khi giao đến tay khách
                hàng.
              </p>
            </CardContent>
          </Card>
