...
import { SellerCustomer, SellerCustomerDetail } from "@/lib/api/customers"
...
import { sellerCustomersApi } from "@/lib/api/customers"
import { toast } from "sonner"

interface CustomersClientProps {
  initialCustomers: SellerCustomer[]
  initialTotalPages: number
  initialPage: number
}

export function CustomersClient({ initialCustomers, initialTotalPages, initialPage }: CustomersClientProps) {
  const [search, setSearch] = useState("")
  const [keyword, setKeyword] = useState("")
  const [page, setPage] = useState(initialPage)
  const [customers, setCustomers] = useState<SellerCustomer[]>(initialCustomers)
